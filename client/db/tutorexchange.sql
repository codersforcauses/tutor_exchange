...
--
-- Host: localhost
-- Generation Time: Feb 17, 2017 at 04:34 AM
...
CREATE TABLE IF NOT EXISTS `sessionComplaint` (
  ...
  KEY `fk_sessionComplaint_guildUser_guildID_idx` (`resolvedBy`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(12311241, 6018, NULL, 1, 0),
(21231231, 6018, NULL, 1, 0);
...
--
-- Dumping data for table `unitTutored`
--
...
(12311241, 'Test User', '2009-04-04', 'M', NULL, 'edc9d523df0a3b8f9387980a3ba858f0c708e87fab0503ded7cc756e670a0d8560dfacd58e9fd3234f26dfd4f890bc197649a869e68d3312cb7f7906446b13e0', '348d64648ff3c136'),
(21231231, 'Test User', '2009-04-04', 'F', NULL, '8b1b3ee8dbebdc75dc9054a76aa71c6a433304f7ef89c4e5c0c7fbae55edb0b7b73563b7fd49e49fd06e326bbafc46ce6546ee638ba77035f49f4885e97bd442', '025534d0b97f733d');
...
ALTER TABLE `sessionComplaint`
  ADD CONSTRAINT `fk_sessionComplaint_guildUser_guildID` FOREIGN KEY (`resolvedBy`) REFERENCES `guildUser` (`guildID`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `tutor`
  ADD CONSTRAINT `fk_tutor_user_userID` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE NO ACTION ON UPDATE CASCADE;
